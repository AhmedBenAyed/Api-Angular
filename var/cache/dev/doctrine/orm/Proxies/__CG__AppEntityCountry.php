...
class Country extends \App\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'continent', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'cities'];
        }
     ...
     * {@inheritDoc}
     */
    public function setImage(string $image): \App\Entity\Country
    {
     ...
     * {@inheritDoc}
     */
    public function setContinent(?\App\Entity\Continent $continent): \App\Entity\Country
    {
