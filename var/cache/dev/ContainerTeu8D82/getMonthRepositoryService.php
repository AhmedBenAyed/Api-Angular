...
// Returns the private 'App\Repository\MonthRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MonthRepository.php';

return $this->privates['App\\Repository\\MonthRepository'] = new \App\Repository\MonthRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
